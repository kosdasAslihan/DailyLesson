...
public class C04_DataCasting {
    public static void main(String[] args) {
        ...
        double sonuc= a/b;
        // java once sag tarafi yapar 15/4= 3.75 bulur ama yukaridaki kuraldan dolayi 3 yapar
        // double sonuc=3;

        System.out.println("bolumu double'a atama yaparsak : " + sonuc); // 3.0

        double dogruSonuc= (double)a/b; // 15.0/4= 3.75
        System.out.println("dogru sonuc icin bir sayiyi double'a cat yapinca : " + dogruSonuc);
    }
}
