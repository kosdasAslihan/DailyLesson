...
public class C01_DataCasting {
    public static void main(String[] args) {
        ...
        /* bi< daha kapsamli data turundeki bir degeri, daha dar kapsamli bir variable'a atamak istersek
        java bunu otomatik yapmayacaktır.
        Cünkü daha kapsamliyi, daha dar kapsamli bir ture cevirmek istiyorsunuz
